...
public class Versao4 {
    public static void main(String[] args) throws Exception {
        ...
        List<List<File>> grupos = dividirEmGrupos(listaArquivos, 6);
        ...
        for (List<File> grupo : grupos) {
            File merged = mergeFiles(grupo, "merged_v4_" + grupoIndex + ".txt");
        ...
        File resultado = new File(pastaResultados, "versao_4_cinco_threads.txt");
