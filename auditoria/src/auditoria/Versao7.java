...
public class Versao7 {
    public static void main(String[] args) throws Exception {
        ...
        List<List<File>> grupos = dividirEmGrupos(listaArquivos, 2);
        ...
        for (List<File> grupo : grupos) {
            File merged = mergeFiles(grupo, "merged_v7_" + grupoIndex + ".txt");
        ...
        File resultado = new File(pastaResultados, "versao_7_quinze_threads.txt");
