...
public class Versao6 {
    public static void main(String[] args) throws Exception {
        ...
        List<List<File>> grupos = dividirEmGrupos(listaArquivos, 3);
        ...
        for (List<File> grupo : grupos) {
            File merged = mergeFiles(grupo, "merged_v6_" + grupoIndex + ".txt");
        ...
        File resultado = new File(pastaResultados, "versao_6_dez_threads.txt");
