...
public class Versao8 {
    public static void main(String[] args) throws Exception {
        ...
        List<List<File>> grupos = dividirEmGrupos(listaArquivos, 1);
        ...
        for (List<File> grupo : grupos) {
            File merged = mergeFiles(grupo, "merged_v8_" + grupoIndex + ".txt");
        ...
        File resultado = new File(pastaResultados, "versao_8_trinta_threads.txt");
