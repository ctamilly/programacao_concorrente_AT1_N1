...
public class Versao3 {
    public static void main(String[] args) throws Exception {
        ...
        List<List<File>> grupos = dividirEmGrupos(listaArquivos, 10);
        ...
        for (List<File> grupo : grupos) {
            File merged = mergeFiles(grupo, "merged" + grupoIndex + ".txt");
        ...
        File resultado = new File(pastaResultados, "versao_3_tres_threads.txt");
